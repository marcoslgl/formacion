...
export interface ApiClassClass extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Details: Schema.Attribute.Component<'details.class-details', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Details: Schema.Attribute.Component<'details.event-details', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    teachers: Schema.Attribute.Relation<'manyToMany', 'api::teacher.teacher'>;
    Themes: Schema.Attribute.Component<'events.theme', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    Type: Schema.Attribute.Enumeration<['Marketing', 'Finance']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiTeacherTeacher extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Details: Schema.Attribute.Component<'details.teacher-details', true>;
    ...
    numberOfClasses: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
